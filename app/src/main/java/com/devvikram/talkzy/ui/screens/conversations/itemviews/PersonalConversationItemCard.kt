...
@Composable
fun PersonalConversationItemCard(
    conversationItem: ConversationItem.PersonalConversation,
    ...
    Row(
        ...
        // Profile Image
        ProfileImage(
            imagePath = conversationItem.localProfilePicPath,
            placeholderRes = R.drawable.baseline_person_24
        )
